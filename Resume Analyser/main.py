...
def run():
    ...
    choice = st.sidebar.selectbox("Choose among given options: ", options)
    img = Image.open('./logo/2799451.png')
        ...
        if pdf_file is not None:
            ...
            with open(save_image_path, "wb") as f:
                ...
                if resume_data:
                    ...
                    st.header("Analysing Resume")
                    st.success("Hii "+ resume_data['name'])
                    ...
                    for i in resume_data['skills']:
                        if i.lower() in ds_keyword:
                            ...
                            st.markdown(
                                '''<h4 style='text-align: left; color: #1ed760;'>Adding these skills will boost the chances of getting a Job</h4>''',
                                unsafe_allow_html=True)
                    ...
                    if 'Declaration' in resume_text:
                        ...
                        st.markdown(
                            '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Declaration.</h4>''',
                            unsafe_allow_html=True)
            ...
            if st.button('Login'):
                if ad_user == 'Avi' and ad_password == 'uemk1234':
                    st.success("Welcome Avi")
